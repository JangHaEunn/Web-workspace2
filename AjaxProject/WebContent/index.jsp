...
<body>
	...
	<script>
		...
		function ajaxTest2(){
			...
			// url에 데이터 내용을 작성하지 않고, send 함수의 매개변수로 작성해야함. 
			// 전송방식도 수정해줘야함. 
	...
	<pre>
		...
		* 부수적인 속성
		...
		- beforeSend : ajax요청을 하기전에 실행되는 이벤트 핸들러 (데이터가공 및 header관련 설정)
		...
		- dataFilter : response 데이터를 받았을 때 정상적인 값을 return할 수 있도록 데이터와 데이터 타입 설정 
		- global : 기본 이벤트 사용여부 => 버퍼링같이 시작과 끝은 나타낼 때, 선처리 작업시 사용함. 
