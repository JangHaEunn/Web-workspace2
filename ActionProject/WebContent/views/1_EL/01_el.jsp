...
<body>
	...
	<h3>2. El을 이용하여 보다 쉽게 Scope에 저장된 값들 출력하기</h3>
	<p>
		EL은 getXXX를 통해 값을 빼올 필요 없이 키값만 제시하면 바로 접근가능 <br>
		내부적으로 해당 scope영역에 해당 키값의 밸류값을 가져올 수 있다. <br>
	...
	<p>
		...
		<%--
			...
			해당 Person객체의 각 필드에 담긴값들을 출력하고자 한다면 키값.필드명으로 접근하면 된다 
	...
	<h3>3. EL사용할 때 내장객체들에 저장된 키값이 동일한 CASE</h3>
