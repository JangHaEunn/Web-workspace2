...
public class ELServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 *    요청 및 응답시 매번 생성되는 객체 
		 *    이 영역에 데이터를 담으면 해당 request로 포워딩 받는 응답jsp에서만 사용 가능 
		 *    => 공유범위가 해당 요청에 대한 응답 jsp
		 *    
		 * 4. PageContext (page scope)
		 *    현재 jsp페이지에서만 사용 가능. 
		 *    => 공유범위가 가장 적음. 
		 *    
		 * 위 객체들에 값을 담을때는 객체.setAttribute("키", 담고자하는 데이터)
		 *              꺼낼때는 getAttribute("키");
		 *              삭제    removeAttribute("키")   
		 * 위 객체들은 모두 jsp페이지에서 별도의 임포트, 변수선언 없이 사용할 수 있도록 기본적으로 내장되어있다.  
		 * 
		 */
