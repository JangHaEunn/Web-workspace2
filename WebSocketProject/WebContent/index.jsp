...
<script>
	// 웹소켓 서버에 연결하기 
	// WebSocket 객체 생성하기 192.168.30.167
	// const socket = new WebSocket("ws://ip:port/<%=request.getContextPath() %>/chatting.do")
	const socket = new WebSocket("ws://192.168.30.167:8082/<%=request.getContextPath()%>/chatting2.do");
	// https://ip:포트번호/~~
	// http -> ws:~
	// https -> wss:~
	...
	socket.onmessage = function(e){
		...
		console.log(e);
		console.log(e.data);
		//Object형태의 String 데이터를 객체로 변환해주기(JSONObject)
