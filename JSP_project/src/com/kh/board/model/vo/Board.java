...
//	STATUS	VARCHAR2(1 BYTE)
	...
	private String category; // 게시글 작성시 번호(category_no)를 그대로 받는 경우와, 조회시 카테고리명(category_name)으로 조회하는 케이스 
	private String boardTitle;
	private String boardContent;
	private String boardWriter; // 작성시 회원번호(user_no), 조회시 회원아이디(user_id)를 저장 
	private int count;
