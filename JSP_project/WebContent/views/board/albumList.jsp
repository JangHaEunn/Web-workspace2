  ...
  <%@include file="boardMain.jsp" %>
        ...
        <div id="board_area">
          ...
          <div id="mo_picture" >
            <div id="mo_picture_wrap">
              ...
              >
                <div id="slider-div" >
                  <div ><img src="/views/resources/img/flower" class="img_1" ></div>
              	 <div><img src="/views/resources/image/사진 11_1.png" class="img_1"></div>
                  <div><img src="/views/resources/image/사진 11_1.png" class="img_1"></div>
                </div>
              </div>
            </div>
          ...
          <div id="mo_write">
            ...
            <!-- 댓글란 -->
           <div class="mo_reply_wrap" style="overflow-y: scroll; display:sticky">
            <div class="mo_reply">
    ...
    <script>
                ...
                if($("#modal").css("visibility")=="hidden"){
                   $("#modal").css("visibility","visible");
                    $("#veil").css("display","block");
                		...
                		location.href="<%=contextPath%>/detail.al?bno="+$("input[name=bno]").val();
      ...
      $("#album_Enroll").click(function () {
		location.href="<%=contextPath%>/insert.th";
	})
            
     
    $("#album_file").click(function () {
		location.href="<%=contextPath%>/al.do";
	})
