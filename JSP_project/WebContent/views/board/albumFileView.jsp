        ...
        <div id="modal">
          <div id="mo_picture" >
            <div id="mo_picture_wrap">
              ...
              >
                <div id="slider-div" >
                  <div ><img src="<%=contextPath %>/views/resources/image/사진33.PNG" class="img_1" ></div>
                  <div><video  class="img_1"  src="/views/resources/video/video1.mp4" controls style="display: block;" ></video></div>
